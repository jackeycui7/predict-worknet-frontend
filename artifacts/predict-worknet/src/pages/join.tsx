    ...
    <div className="animate-fade-up">
      ...
      <div className="grid grid-cols-4 gap-px bg-border/40 border border-border/40">
        ...
        <div className="bg-background p-6">
          ...
          <p className="text-[11px] text-foreground/30 font-light leading-relaxed mb-3">
            Install the AWP skill package and follow the guided registration process.
          </p>
          <div className="bg-foreground text-white px-3 py-2 font-mono text-[10px]">
            <span className="text-white/20 select-none">$ </span>awp skill install
          </div>
        </div>
        <div className="bg-background p-6">
          ...
          <p className="text-[11px] text-foreground/30 font-light leading-relaxed">
            When browsing available subnets, choose Predict WorkNet as your target network.
          </p>
        </div>
        <div className="bg-foreground p-6">
